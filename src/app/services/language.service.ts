...
export class LanguageService {
  ...
  private getEnglishTranslations(): any {
    return {
      ...
      'Monitor and manage file processing tasks': 'Monitor and manage file processing tasks',
      'Total Tasks': 'Total Tasks',
      'Queued': 'Queued',
      'Failed': 'Failed',
      'All Statuses': 'All Statuses',
      'Search by file name or task ID...': 'Search by file name or task ID...',
      ...
      'Previous': 'Previous',
      'Next': 'Next',
      'Failed to load tasks. Please try again.': 'Failed to load tasks. Please try again.',
      'Failed to download task result. Please try again.': 'Failed to download task result. Please try again.',
      'Are you sure you want to retry this task?': 'Are you sure you want to retry this task?',
      'Failed to retry task. Please try again.': 'Failed to retry task. Please try again.',
      'Are you sure you want to cancel this task?': 'Are you sure you want to cancel this task?',
      'Failed to cancel task. Please try again.': 'Failed to cancel task. Please try again.',
    };
  }
  ...
  private getVietnameseTranslations(): any {
    return {
      ...
      // File Processing
      'File Processing': 'Xử lý tệp',
      'Monitor and manage file processing tasks': 'Giám sát và quản lý các tác vụ xử lý tệp',
      'Total Tasks': 'Tổng số tác vụ',
      'Queued': 'Đã xếp hàng',
      'Failed': 'Thất bại',
      'All Statuses': 'Tất cả trạng thái',
      'Search by file name or task ID...': 'Tìm kiếm theo tên tệp hoặc mã tác vụ...',
      'Apply Filters': 'Áp dụng bộ lọc',
      'Processing Tasks': 'Tác vụ đang xử lý',
      'Loading tasks...': 'Đang tải tác vụ...',
      'Retry': 'Thử lại',
      'Task ID': 'Mã tác vụ',
      'File Name': 'Tên tệp',
      'Progress': 'Tiến độ',
      ...
      'Download': 'Tải xuống',
      'Cancel': 'Hủy',
      'No tasks found': 'Không tìm thấy tác vụ nào',
      'Showing': 'Hiển thị',
      'to': 'đến',
      'of': 'của',
      'results': 'kết quả',
      'Previous': 'Trước',
      'Next': 'Sau',
      'Failed to load tasks. Please try again.': 'Không thể tải tác vụ. Vui lòng thử lại.',
      'Failed to download task result. Please try again.': 'Không thể tải xuống kết quả tác vụ. Vui lòng thử lại.',
      'Are you sure you want to retry this task?': 'Bạn có chắc chắn muốn thử lại tác vụ này không?',
      'Failed to retry task. Please try again.': 'Không thể thử lại tác vụ. Vui lòng thử lại.',
      'Are you sure you want to cancel this task?': 'Bạn có chắc chắn muốn hủy tác vụ này không?',
      'Failed to cancel task. Please try again.': 'Không thể hủy tác vụ. Vui lòng thử lại.',
    };
  }
}